...
<head>
    ...
    <style>
        ...
        .stat-card .num  { font-size: 2rem; color: #d4af37; font-weight: bold; }
        ...
        .action-card:hover { border-color: #d4af37; }
        .action-card h3 { color: #d4af37; margin-bottom: 8px; }
        .action-card p  { font-size: 0.85rem; color: #888; }
        .welcome { color: #d4af37; margin-bottom: 5px; }
        .last-import { font-size: 0.8rem; color: #666; margin-top: 30px; }
    </style>
</head>
<body>
