...
Date: March 23 2026
Description: This file is used to attach certain music tracks provided by the client to certain images, which are matched by ID and name.
-->
...
$allImages = [
    ...
    [
        ...
        'tag'     => 'candid',
        'span'    => 'normal',
        'music'   => 'audio/unforgettable.mp3', // unfortunately we do not have enough tracks from the client to fill in all spots at the moment
    ],
    [
        'id'      => 15,
